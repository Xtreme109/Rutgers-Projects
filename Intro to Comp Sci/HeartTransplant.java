...
public class HeartTransplant {
     ...
     * Returns patients
     */
    public Patient[] getPatients(Patient[] patients) {
     ...
     */
    public SurvivabilityByAge getSurvivabilityByAge(SurvivabilityByAge survivabilityByAge) {
        this.survivabilityByAge = survivabilityByAge;
     ...
     */
    public SurvivabilityByCause getSurvivabilityByCause(SurvivabilityByCause survivabilityByCause) {
